...
"""
Toy example of one woman and two men (from presentaiton)
"""
def test_toy_example_one_woman_two_men_welfare():
    # List of organs
    omega = 3
    ...
    for obj in ['welfare', 'envy']:
        m = allocate_organs(
            organs, patients, organ_times, E_times, M_times,
            obj=obj, flag_liver_size=True,
...
"""
100 time steps, receiving one patient and one organ at a time, all compatible
"""
